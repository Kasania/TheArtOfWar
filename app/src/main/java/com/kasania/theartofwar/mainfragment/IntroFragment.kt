...
class IntroFragment :Fragment(), MainActivity.OnBackPressedListener {
    ...
    override fun onBack() {
        ...
        //for (b in 0..fragmentManager!!.backStackEntryCount) {
            fragmentManager!!.popBackStack("Intro", FragmentManager.POP_BACK_STACK_INCLUSIVE)
        //}
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        //view.intro.setBackgroundResource(R.drawable.intro)
        return view
    }
